  ...
  return (
    <div className="sm:px-40  min-h-screen w-full overflow-hidden flex flex-col   text-white">
      <img
        ...
        src={`https://image.tmdb.org/t/p/w500${series[0].backdrop_path}`}
        alt=""
      />
        ...
        <div className="flex flex-col  sm:flex-row">
          <div className="m-5 flex gap-5">
            ...
            <img
              ...
              src={`https://image.tmdb.org/t/p/w500${series[0].poster_path}`}
              alt=""
            />
            <div>
              ...
              <p className="sm:hidden">{series[0].first_air_date}</p>
              <p className="sm:hidden">{series[0].vote_average}</p>
            </div>
          </div>
          ...
          <div className=" flex flex-col flex-wrap w-[100%] m-5">
            <div className="flex flex-col sm:flex-row  gap-2 sm:gap-7">
              ...
              <p className="hidden sm:block">{series[0].first_air_date}</p>
              <p className="hidden sm:block">{series[0].vote_average}</p>
            </div>
