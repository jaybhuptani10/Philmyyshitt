...
const Page2 = () => {
  return (
    <div className="text-white py-20">
      ...
      <div className="py-10 w-[100%] justify-center flex gap-2 flex-wrap">
        <div className="px-5  landscape:w-[400px]   text-black bg-[#CBD2D0] hover:bg-[#FE938C] cursor-pointer flex items-center gap-1 details-card">
          <svg
          ...
          <h1 className="w-[75%] sm-landscape:text-xs font-bold">
            Keep track of every Movie / Show you watch
          </h1>
        </div>
        <div className="px-5 sm-landscape:w-[200px] sm-landscape:min-w-[250px] landscape:w-[400px] landscape:h-[100px] text-black bg-[#CBD2D0] cursor-pointer flex items-center gap-1 details-card  hover:bg-[#4281A4]">
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            height="3.5em"
          ...
          <h1 className="w-[75%] sm-landscape:text-sm  font-bold">
            Mark your favourite Movie / Show and show them to your friends
          </h1>
        </div>
        <div className="px-5  text-black  sm-landscape:w-[200px] sm-landscape:min-w-[250px] landscape:h-[100px] landscape:w-[400px] bg-[#CBD2D0] cursor-pointer flex items-center gap-1 details-card hover:bg-[#1D7874]">
          <svg
            viewBox="0 0 16 16"
            fill="currentColor"
            height="3.5em"
        ...
        <div className="px-5 sm-landscape:w-[200px] sm-landscape:min-w-[250px] landscape:w-[400px] landscape:h-[100px]  text-black bg-[#CBD2D0] cursor-pointer flex items-center gap-1 details-card  hover:bg-[#FE938C]">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            height="3.5em"
        ...
        <div className="px-5 sm-landscape:w-[200px] sm-landscape:min-w-[250px] landscape:w-[400px] landscape:h-[100px] text-black bg-[#CBD2D0] cursor-pointer flex items-center gap-1 details-card hover:bg-[#1D7874] ">
          <svg
            viewBox="0 0 16 16"
            fill="currentColor"
            height="3.5em"
